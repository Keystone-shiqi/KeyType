#!/usr/bin/env python3
"""
KeyType ASR hotword/mapping test harness.
...
Expects:
    - credentials in ~/Library/Application Support/KeyType/credentials.json
    - ffmpeg on PATH
...
CREDENTIALS_PATH = Path.home() / "Library/Application Support/KeyType/credentials.json"
...
async def main():
    ...
    print(f"{'=' * 70}")
    print(f"  KeyType ASR Test Harness")
