...
MODEL_PATH = os.path.expanduser("~/projects/keytype/sensevoice-server/models/Qwen3-4B-Q4_K_M.gguf")
RESULTS_PATH = os.path.expanduser("~/projects/keytype/scripts/benchmark_results.json")
