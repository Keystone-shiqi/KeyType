#!/usr/bin/env python3
"""
KeyType Vocabulary ASR Accuracy Test
...
CREDS_PATH = Path.home() / "Library/Application Support/KeyType/credentials.json"
SNIPPETS_PATH = Path.home() / "Library/Application Support/KeyType/builtin-snippets.json"
HOTWORDS_PATH = Path.home() / "Library/Application Support/KeyType/builtin-hotwords.json"
...
async def main():
    p = argparse.ArgumentParser(description="KeyType Vocabulary ASR Accuracy Test")
    ...
    banner("KeyType Vocabulary ASR Accuracy Test")
