...
#   KeyType/Bridge/SherpaOnnxBridge.swift  (copied from sherpa-onnx)
#
# =============================================================================
...
BRIDGE_DIR="$PROJECT_ROOT/KeyType/Bridge"
...
if [ -f "$BRIDGE_DIR/SherpaOnnxBridge.swift" ]; then
    ...
    echo "→ Copied SherpaOnnx.swift → KeyType/Bridge/SherpaOnnxBridge.swift"
else
...
if [ -n "$HEADER" ]; then
    ...
    echo "→ Copied C header → KeyType/Bridge/sherpa-onnx-c-api.h"
fi
