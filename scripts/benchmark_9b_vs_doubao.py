...
CREDS_PATH = os.path.expanduser("~/Library/Application Support/KeyType/credentials.json")
MODEL_9B = os.path.expanduser("~/projects/keytype/sensevoice-server/models/Qwen3.5-9B-Q4_K_M.gguf")
RESULTS_PATH = os.path.expanduser("~/projects/keytype/scripts/benchmark_9b_vs_doubao_results.json")
