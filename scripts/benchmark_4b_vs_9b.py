...
DB_PATH = os.path.expanduser("~/Library/Application Support/KeyType/history.db")
MODEL_4B = os.path.expanduser("~/projects/keytype/sensevoice-server/models/qwen3-4b-q4_k_m.gguf")
MODEL_9B = os.path.expanduser("~/projects/keytype/sensevoice-server/models/Qwen3.5-9B-Q4_K_M.gguf")
RESULTS_PATH = os.path.expanduser("~/projects/keytype/scripts/benchmark_4b_vs_9b_results.json")
