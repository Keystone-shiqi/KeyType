...
**文件:** `KeyType/Services/SenseVoiceServerManager.swift`
...
2. Dev mode: `~/projects/keytype/sensevoice-server/models/Qwen3-4B-Q4_K_M.gguf`

### Task 2: LLM 客户端自动切换 base URL

**文件:** `KeyType/LLM/DoubaoChatClient.swift` 或对应的 LLM 客户端
...
**文件:** `KeyType/UI/Settings/GeneralSettingsTab.swift`
...
| `KeyType/Services/SenseVoiceServerManager.swift` | 需要加 `--llm-model` 参数 |
| `KeyType/LLM/DoubaoChatClient.swift` | LLM 客户端，需要支持本地 base URL |
| `KeyType/UI/Settings/GeneralSettingsTab.swift` | 需要加本地 LLM 选项 |
