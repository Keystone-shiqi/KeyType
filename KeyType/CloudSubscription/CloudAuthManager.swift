// KeyType/Auth/CloudAuthManager.swift
...
final class CloudAuthManager: ObservableObject, Sendable {
    ...
    private let logger = Logger(subsystem: "com.keytype.app", category: "CloudAuth")
...
enum CloudAuthError: Error, LocalizedError {
    ...
    var errorDescription: String? {
        switch self {
        case .notConfigured: return "KeyType Cloud is not configured"
