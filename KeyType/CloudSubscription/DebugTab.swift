...
// Hidden by default. Enable with: defaults write com.keytype.app tf_debug_panel -bool true
// Disable with: defaults delete com.keytype.app tf_debug_panel
...
struct DebugTab: View, SettingsCardHelpers {
    ...
    private let logger = Logger(subsystem: "com.keytype.app", category: "DebugTab")
