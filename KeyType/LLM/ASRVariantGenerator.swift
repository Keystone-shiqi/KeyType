...
enum GenerationError: LocalizedError {
    ...
    var errorDescription: String? {
        ...
        #if HAS_CLOUD_SUBSCRIPTION
        case .paidOnly:
            return L("此功能需要 KeyType Cloud 付费订阅", "This feature requires a paid KeyType Cloud subscription")
        #endif
        }
    }
}
...
actor ASRVariantGenerator {
    ...
    private let logger = Logger(subsystem: "com.keytype.llm", category: "ASRVariantGenerator")
