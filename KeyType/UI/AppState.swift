...
extension Notification.Name {
    static let modesDidChange = Notification.Name("KeyTypeModesDidChange")
    static let asrProviderDidChange = Notification.Name("KeyTypeASRProviderDidChange")
    static let hotkeyRecordingDidStart = Notification.Name("KeyTypeHotkeyRecordingDidStart")
    static let hotkeyRecordingDidEnd = Notification.Name("KeyTypeHotkeyRecordingDidEnd")
    static let navigateToMode = Notification.Name("KeyTypeNavigateToMode")
    static let navigateToHistory = Notification.Name("KeyTypeNavigateToHistory")
    static let navigateToVocabulary = Notification.Name("KeyTypeNavigateToVocabulary")
    static let selectMode = Notification.Name("KeyTypeSelectMode")
}
