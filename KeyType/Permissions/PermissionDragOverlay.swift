...
/// window, carrying a draggable representation of KeyType.app so the user
...
/// `KeyType.app` bundle. macOS's TCC registration treats a dropped app
...
private struct PermissionDragOverlayView: View {
    ...
    /// Builds "拖 KeyType 到上方列表以允许辅助功能" with the app and permission
    ...
    private var dragChip: some View {
        ...
        // the live `KeyType.app` bundle URL so the target (System Settings
