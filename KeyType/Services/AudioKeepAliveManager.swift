...
enum AudioKeepAliveManager {
    ...
    private static let logger = Logger(subsystem: "com.keytype.keepalive", category: "AudioKeepAlive")
    private static let queue = DispatchQueue(label: "com.keytype.keepalive.mic", qos: .background)
