...
struct UpdateInfo: Codable, Identifiable {
    ...
    private static func releaseAssetURL(version: String, suffix: String) -> URL {
        URL(string: "https://github.com/Keystone-shiqi/keytype/releases/download/v\(version)/KeyType-v\(version)-\(suffix).dmg")!
    }
}
...
final class UpdateChecker {
    ...
    private let url = URL(string: "https://raw.githubusercontent.com/Keystone-shiqi/keytype/main/updates.json")!
