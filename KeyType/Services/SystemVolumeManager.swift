...
enum SystemVolumeManager {
    ...
    private static let logger = Logger(subsystem: "com.keytype.volume", category: "SystemVolumeManager")

    /// Dedicated serial queue for CoreAudio property access.
    private static let queue = DispatchQueue(label: "com.keytype.volume.coreaudio", qos: .userInitiated)
