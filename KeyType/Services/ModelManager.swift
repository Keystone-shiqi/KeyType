...
actor ModelManager {
    ...
    private let logger = Logger(subsystem: "com.keytype.models", category: "ModelManager")
    ...
    nonisolated static var isQwen3ASRBundled: Bool {
        ...
        let devPath = (home as NSString).appendingPathComponent("projects/keytype/qwen3-asr-server/server.py")
