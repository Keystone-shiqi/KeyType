...
extension Notification.Name {
    static let audioInputDevicesDidChange = Notification.Name("KeyTypeAudioInputDevicesDidChange")
}

final class AudioInputDeviceMonitor {
    static let shared = AudioInputDeviceMonitor()

    private let queue = DispatchQueue(label: "com.keytype.audio.input-devices", qos: .utility)
