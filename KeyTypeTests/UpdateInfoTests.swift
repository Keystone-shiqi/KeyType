...
final class UpdateInfoTests: XCTestCase {
    ...
    func testDownloadURLUsesLocalAssetForLocalInstallations() throws {
        let update = try decodeUpdate("""
        {
          ...
          "date": "2026-06-01",
          "notes": "Fix updater",
          "cloud_dmg_url": "https://example.com/KeyType-cloud.dmg",
          "cloud_dmg_size": 1234,
          "cloud_dmg_sha256": "cloudhash",
          "local_dmg_url": "https://example.com/KeyType-local.dmg",
          "local_dmg_size": 5678,
        ...
        XCTAssertEqual(
            ...
            "https://example.com/KeyType-cloud.dmg"
        )
        XCTAssertEqual(
            update.downloadURL(isLocalInstallation: true).absoluteString,
            "https://example.com/KeyType-local.dmg"
        )
    ...
    func testDownloadURLFallsBackToVariantSpecificReleaseAssetNames() throws {
        ...
        XCTAssertEqual(
            update.downloadURL(isLocalInstallation: false).absoluteString,
            "https://github.com/Keystone-shiqi/keytype/releases/download/v1.9.5/KeyType-v1.9.5-cloud.dmg"
        )
        XCTAssertEqual(
            update.downloadURL(isLocalInstallation: true).absoluteString,
            "https://github.com/Keystone-shiqi/keytype/releases/download/v1.9.5/KeyType-v1.9.5-local-apple-silicon.dmg"
        )
    }
