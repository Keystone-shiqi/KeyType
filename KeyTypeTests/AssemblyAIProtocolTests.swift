    ...
    func testBuildWebSocketURL_usesExpectedQueryItemsForUniversalStreaming() throws {
        ...
        let url = try AssemblyAIProtocol.buildWebSocketURL(
            ...
            options: ASRRequestOptions(
                enablePunc: true,
                hotwords: [" KeyType ", String(repeating: "a", count: 70), "keep-me"],
        ...
        let hotwords = [" KeyType ", String(repeating: "a", count: 70), "keep-me"]
        ...
        XCTAssertEqual(terms, ["KeyType", String(repeating: "a", count: 50), "keep-me"])
    }
